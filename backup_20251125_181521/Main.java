...
public class Main extends Application {
      ...
      public void start(Stage primaryStage) {
            ...
            encryptBtn.setOnAction(new EventHandler<ActionEvent>() {
                  ...
                  public void handle(ActionEvent event) {
                        ...
                        CryptoUtils.encrypt(new File(selectedFile), secretKey, uiFileList);
                  }
            });
            ...
            decryptBtn.setOnAction(new EventHandler<ActionEvent>() {
                  ...
                  public void handle(ActionEvent event) {
                        ...
                        CryptoUtils.decrypt(new File(selectedFile), secretKey, uiFileList);
                  }
            });
      ...
      @Override
      public void stop() {
            System.out.println("Application closing... restoring file names.");
            CryptoUtils.restoreOriginalNames(uiFileList);
      }
